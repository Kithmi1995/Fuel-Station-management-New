...
<body background="back-ground.jpg.jpg">
  ...
  <form width=70% action="/action_page.php">
    ...
    <input type="text" id="fname" name="firstname" placeholder="Enter Last name.."><br>

    <label for="ftype">NIC</label><br>
    <input type="text" id="lname" name="lastname" placeholder="Enter NIC Number.."><br>

     <label for="fid">Address</label><br>
    <input type="text" id="fname" name="firstname" placeholder="Enter Address.."><br>


    <label for="uprice">Contact Number</label><br>
    <input type="text" id="lname" name="lastname" placeholder="Enter Contact Number.."><br>
      
    <label for="uprice">Email</label><br>
    <input type="email" id="lname" name="lastname" placeholder="Enter Email.."><br>

    <label for="uprice">Date Of Birth</label><br>
    <input type="date" id="lname" name="lastname" placeholder="Enter Birth Date.."><br>
    ...
    <input type="text" id="lname" name="lastname" placeholder="Enter username.."><br>
      
     <label for="uprice">Password</label><br>
    <input type="password" id="lname" name="lastname" placeholder="Enter passwrd.."><br>
      
    <label for="uprice">Confirm Password</label><br>
    <input type="password" id="lname" name="lastname" placeholder="Confirm password.."><br>
