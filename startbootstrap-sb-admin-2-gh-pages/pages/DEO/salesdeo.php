...
<body background="back-ground.jpg.jpg">
  ...
  <form width=70% action="/action_page.php">
    ...
    <input type="text" id="fname" name="firstname" placeholder="Enter Pumper ID.."><br>
     ...
     <label for="fid">Pumper NIC</label><br>
    <input type="text" id="fname" name="firstname" placeholder="Enter pumper NIC.."><br>
    ...
    <input type="text" id="fname" name="firstname" placeholder="Enter closing Meter Readings.."><br>


    <label for="uprice">Starting Time</label><br>
    <input type="time" id="lname" name="lastname" placeholder="Enter Starting Time.."><br>

    <label for="uprice">Ending Time</label><br>
    <input type="time" id="lname" name="lastname" placeholder="Enter Ending Time.."><br>

    <label for="uprice">Date</label><br>
    <input type="date" id="lname" name="lastname" placeholder="Enter Date.."><br>
