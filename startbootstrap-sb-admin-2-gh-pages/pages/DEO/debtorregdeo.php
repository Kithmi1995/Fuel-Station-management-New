...
<body>
  ...
  <form width=70% action="/action_page.php">
    ...
    <input type="text" id="fname" name="firstname" placeholder="Enter Debtor Name/Company Name .."><br>


     <label for="fid">Email</label><br>
    <input type="text" id="fname" name="firstname" placeholder="Enter Email.."><br>

    <label for="ftype">Tank ID</label><br>
    <input type="text" id="lname" name="lastname" placeholder="Your NIC Number.."><br>
