...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php"><i class="fa fa-dashboard fa-fw"></i> Data entry Operator</a>
                        </li>
  ...
  <form width=70% action="/action_page.php">
    ...
    <input type="text" id="lname" name="lastname" placeholder="Enter Fuel Type.."><br>


    <label for="uprice">Unit Price</label><br>
    <input type="text" id="lname" name="lastname" placeholder="Enter Unit Price.."><br>
