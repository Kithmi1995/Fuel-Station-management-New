...
<body>
                        ...
                        <li>
                          ...
                          <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="cashdeo.php">Cash Sales</a>
                                </li>
                                <li>
  ...
  <form width=70% action="/action_page.php">
    ...
    <input type="text" id="fname" name="firstname" placeholder="Enter Pump ID.."><br>
    ...
    <input type="text" id="lname" name="lastname" placeholder="Enter Tank ID.."><br>
